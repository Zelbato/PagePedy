...
if ($estoque_tipo === 'Matéria Prima') {
    ...
    $sql = "INSERT INTO estoque (estoque_matp_id, estoque_tipo, estoque_quantidade, estoque_status, data_entrada, data_saida)
            VALUES ('$estoque_matp_id', '$estoque_tipo', '$estoque_quantidade', '$estoque_status', '$data_entrada', '$data_saida')";
} 
...
if ($conexao->query($sql) === TRUE) {
    ...
    echo "<a href='cadastro_estoque.html'>Voltar</a>";
} else {
